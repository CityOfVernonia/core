...
import type { AreaUnitInfo, ElevationUnitInfo, LatitudeLongitudeUnitInfo, LengthUnitInfo } from './../support/_Units';
...
// geometry
import Units from './../support/_Units';
// import _Units from './../support/_Units';
...
export default class Measure extends Widget {
  ...
  render(): tsx.JSX.Element {
    ...
    return (
      <calcite-panel heading="Measure">
        ...
        {/* {operation === 'ready' && _popupVisible && _selectedFeature ? (
          <calcite-button
            icon-start="measure"
            slot="footer"
            width="full"
  ...
  private _renderMeasureSelectedFeatureButton(): tsx.JSX.Element | null {
    ...
    return <calcite-button slot="footer">Selected {text[type]}</calcite-button>;
  }
}
