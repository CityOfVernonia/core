...
export default class ActionBarLayout extends Layout {
  ...
  private _createActionGroups(): void {
    ...
    const bottomActions: tsx.JSX.Element[] = [];
   ...
   * @param actionBar
   */
  private _setViewPadding(actionBar: HTMLCalciteActionBarElement): void {
  ...
  render(): tsx.JSX.Element {
    ...
    return (
      <calcite-shell content-behind="">
        ...
        {/* shell panel */}
        <calcite-shell-panel slot="primary-panel" position={position} detached="">
          <calcite-action-bar class={CSS.actionBar} slot="action-bar" afterCreate={this._setViewPadding.bind(this)}>
