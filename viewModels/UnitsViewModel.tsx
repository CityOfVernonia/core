...
export default class UnitsViewModel extends Accessor {
  ...
  /**
   * Return location <calcite-select> which updates `locationUnit` property on change.
   *
   * @param name <select> `name` attribute
   * @param title <select> `title` attribute
  ...
  calciteLocationSelect(
    ...
    return (
      ...
      >
        {this._createCalciteUnitOptions(this.locationUnits, this.locationUnit)}
      </calcite-select>
    );
  }
  ...
  /**
   * Return length <calcite-select> which updates `areaUnit` property on change.
   *
   * @param name <select> `name` attribute
   * @param title <select> `title` attribute
   * @param theme calcite `theme` attribute
  ...
  calciteAreaSelect(
    ...
    return (
      <calcite-select
        ...
        afterCreate={(calciteSelect: HTMLCalciteSelectElement) => {
          calciteSelect.addEventListener('calciteSelectChange', () => {
            this.areaUnit = calciteSelect.selectedOption.value;
          });
        }}
      >
        {this._createCalciteUnitOptions(this.areaUnits, this.areaUnit.toString())}
      </calcite-select>
    );
  }
  ...
  calciteElevationSelect(
    ...
    return (
      ...
      >
        {this._createCalciteUnitOptions(this.elevationUnits, this.elevationUnit)}
      </calcite-select>
    );
  }
