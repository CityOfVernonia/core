...
const widgets = ['Attribution', 'Feature', 'Features', 'LayerList', 'Popup', 'Search', 'Zoom'];
...
(async () => {
  try {
    ...
    const calciteDest = path.resolve(__dirname, './../dev/public/arcgis/components/assets');
    ...
    const mapComponentDest = path.resolve(__dirname, './../dev/public/map-components/assets');
